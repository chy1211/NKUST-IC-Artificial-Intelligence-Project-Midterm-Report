...
for chunk in text_chunks:
    data = {"model": "nomic-ai/nomic-embed-text-v1.5-GGUF", "input": chunk}
...
for question in questions:
    question_data = {"model": "nomic-ai/nomic-embed-text-v1.5-GGUF", "input": question}
